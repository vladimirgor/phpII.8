...
// Access to service isn't allowed!
            header('Location: /index.php?c=article&a=Show_all&access=Edit');
...
// Is it allowed to user to delete articles?
        if ( $user == null || !$mUsers->Can('DELETE_ARTICLE',$user['id_role']) )
            {
// Access to service isn't allowed!
            header('Location: /index.php?c=article&a=Show_all&access=Delete');
            exit();
            }
...
// article Add
    protected  function Action_add (){
        ...
        {
// Access to service isn't allowed!
            header('Location: /index.php?c=article&a=Show_all&access=Add');
